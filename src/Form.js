            ...
            <form>
                ...
                <div className="form-group">
                    ...
                    <input className="form-control mt-2"
                        ...
                        value={product.stockquntity}
                        onChange={changeFormData}

                        type="number" name="stockquantity" placeholder="stockquantity" />
                    {
                        sumitted && product.stockquantity === "" && <span className="text-danger">stockquntity required</span>
                    }
                </div>
